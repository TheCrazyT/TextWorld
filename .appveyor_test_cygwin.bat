...
%BASH% cd /cygdrive/c/projects/textworld ^&^& %PYTHON_EXE% -m nose -sv --with-xunit --with-coverage --cover-xml --cover-html --cover-package textworld ^&^& %PYTHON_EXE% -m nose -sv tests/test*'
